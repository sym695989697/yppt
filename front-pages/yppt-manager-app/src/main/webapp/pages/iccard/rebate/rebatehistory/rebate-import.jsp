...
<script src="rebate-import.js" type="text/javascript" charset="utf-8"></script>
...
<body style="padding: 10px;">
	<form action="" name="f_form" id="f_form" enctype="multipart/form-data"
		...
		<div id="editForm1" align="center" style="margin-top: 20px">
				<table border="0">
					<tr class='hideTr'>
						<td align="right" height="50" valign="top">发卡地区：</td>
						<td align="left"  height="50" valign="top">
							<input type="text" id="opencardofficecode" name="opencardofficecode"/>
						</td>
					</tr>
					<tr class='hideTr'>
						<td align="right" height="50" valign="top">账单期：</td>
						<td align="left"  height="50" valign="top">
							<input type="text" name="dateYearAndMonth" readonly="readonly" id="dateYearAndMonth" onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM'});"/>
						</td>
					</tr>
					<tr>
