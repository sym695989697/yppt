...
<script type="text/javascript" src="invoice-vat.js?v=g_version"></script> 
</head>
	...
	<form name="form1" method="post" action="" id="form1">
		...
		<div id="tableDiv" style="overflow: auto; height: 350px;">
			<table cellpadding="0" cellspacing="0" class="l-table-edit" align="center">
				...
				<tr>
					<td width="100" align="right" class="l-table-edit-td"><span style="color: red;">*&nbsp;</span>纳税人名称:</td>
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<input type="text" name="taxName" id="taxName" />
					</td>
					
					<td width="100" align="right" class="l-table-edit-td"><span style="color: red;">*&nbsp;</span>税号:</td>
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<input type="text" name="taxNo" id="taxNo" />
					</td>
					
					<td width="100" align="right" class="l-table-edit-td"><span style="color: red;">*&nbsp;</span>地址:</td>
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<input type="text" name="invoiceArea" id="invoiceArea" />
					</td>
				</tr>
				<tr>
					<td width="100" align="right" class="l-table-edit-td"><span style="color: red;">*&nbsp;</span>开户行:</td>
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<input type="text" name="invoiceOpenBankName" id="invoiceOpenBankName" />
					</td>
					
					<td width="100" align="right" class="l-table-edit-td"><span style="color: red;">*&nbsp;</span>账号:</td>
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<input type="text" name="invoiceOpenBankAccount" id="invoiceOpenBankAccount" />
					</td>
					
					<td width="100" align="right" class="l-table-edit-td"><span style="color: red;">*&nbsp;</span>电话:</td>
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<input type="text" name="invoicePhone" id="invoicePhone" />
					</td>
				</tr>
				...
				<tr>
					...
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<a href="javascript:void(0)" id="imgHref" title="点击查看大图" onclick="window.invoicevat.queryBigImg('businessLicenseUrl')">查看</a>
						<img id="_businessLicenseUrl"  height="40" width="40" style="cursor: pointer;display: none;"/>
					</td>
					
					<td width="100" align="right" class="l-table-edit-td"><span style="color: red;">*&nbsp;</span>证件截止日期:</td>
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<input type="text" name="businessLicenseDeadlines" id="businessLicenseDeadlines" />
					</td>
				...
				<tr>
					...
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<a href="javascript:void(0)" id="imgHref" title="点击查看大图" onclick="window.invoicevat.queryBigImg('orgCodeCertificateUrl')">查看</a>
						<img id="_orgCodeCertificateUrl"  height="40" width="40" style="cursor: pointer;display: none;"/>
					</td>
					
					<td width="100" align="right" class="l-table-edit-td"><span style="color: red;">*&nbsp;</span>证件截止日期:</td>
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<input type="text" name="orgCodeCertificateDeadlines" id="orgCodeCertificateDeadlines" />
					</td>
				...
				<tr>
					...
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<a href="javascript:void(0)" id="imgHref" title="点击查看大图" onclick="window.invoicevat.queryBigImg('taxRegCertificateUrl')">查看</a>
						<img id="_taxRegCertificateUrl"  height="40" width="40" style="cursor: pointer;display: none;"/>
					</td>
					
					<td width="100" align="right" class="l-table-edit-td"><span style="color: red;">*&nbsp;</span>证件截止日期:</td>
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<input type="text" name="taxRegCertificateDeadlines" id="taxRegCertificateDeadlines" />
					</td>
				...
				<tr>
					...
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<a href="javascript:void(0)" id="imgHref" title="点击查看大图" onclick="window.invoicevat.queryBigImg('generalTaxProveUrl')">查看</a>
						<img id="_generalTaxProveUrl"  height="40" width="40" style="cursor: pointer;display: none;"/>
					</td>
					
					<td width="100" align="right" class="l-table-edit-td"><span style="color: red;">*&nbsp;</span>证件截止日期:</td>
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<input type="text" name="generalTaxProveDeadlines" id="generalTaxProveDeadlines" />
					</td>
				...
				<tr>
					...
					<td width="100" align="left" class="l-table-edit-td" style="word-break:break-all;">
						<a href="javascript:void(0)" id="imgHref" title="点击查看大图" onclick="window.invoicevat.queryBigImg('invoiceFileUrl')">查看</a>
				...
				<tr>
	                ...
	                <td width="100" align="left">
	                	<input type="radio" id="agree" name="approvalResult"  checked="checked" value="2"/>同意&nbsp;&nbsp;
	                	<input type="radio" id="disagree" name="approvalResult" value="3" />不同意
	                </td>
	            </tr>
				...
				<tr>
					<td colspan="6" align="center">
						<input type="submit" value="审核" id="submit" class="l-button l-button-submit" />
					</td>
				</tr>
