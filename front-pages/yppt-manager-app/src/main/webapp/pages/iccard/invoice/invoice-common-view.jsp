...
<script type="text/javascript" src="invoice-common-view.js?v=g_version"></script> 
</head>
		...
		<div id="tableDiv" style="overflow: auto; height: 350px;">
			<table cellpadding="0" cellspacing="0" class="l-table-edit" align="center">
				...
				<tr>
					...
					<td width="100" width="10%" align="left" class="l-table-edit-td" id="invoiceType" style="word-break:break-all;"></td>
