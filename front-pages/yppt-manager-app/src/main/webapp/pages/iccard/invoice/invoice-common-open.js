...
(function() {
	...
	var Invoicecommonopen = function() {
		this.init();
	};
	
	Invoicecommonopen.prototype = {
		config : {
...
//	   						params['model.invoiceMoney']=$("#invoiceMoney").text();
	   						...
	   						params['model.actualInvoiceMoney']=$("#actualInvoiceMoney").text();
	   						var expressInfo = $("#invoiceOpenerName").val() + "  " +$("#userRegPhone").text();
	...
	$(document).ready(function() {
		window.invoicecommonopen = new Invoicecommonopen();
	});
})();