...
<script type="text/javascript" src="invoice-common.js?v=g_version"></script> 
</head>
		...
		<div id="tableDiv" style="overflow: auto; height: 350px;">
			<table cellpadding="0" cellspacing="0" class="l-table-edit" align="center">
				...
				<tr>
					...
					<td width="100" align="left" class="l-table-edit-td" id="userRegPhone" style="word-break:break-all;">
					</td>
					
					<td width="100" align="right" class="l-table-edit-td">会员名称:</td>
					<td width="100" align="left" class="l-table-edit-td" id="userName" style="word-break:break-all;">
					</td>
				</tr>
				...
				<tr>
					...
					<td width="100" align="left" class="l-table-edit-td" id="invoiceOpenerName" style="word-break:break-all;"></td>
					
					<td width="100" align="right" class="l-table-edit-td">快递公司:</td>
					<td width="100" align="left" class="l-table-edit-td" id="expressCompany" style="word-break:break-all;"></td>
					
					<td width="100" align="right" class="l-table-edit-td">开票金额:</td>
					<td width="100" align="left" class="l-table-edit-td" id="actualInvoiceMoney" style="word-break:break-all;"></td>
				</tr>
				
				<tr>
					<td width="100" align="right" class="l-table-edit-td">快递单号:</td>
					<td width="100" align="left" class="l-table-edit-td" id="expressOrderNo" style="word-break:break-all;"></td>
				</tr>
