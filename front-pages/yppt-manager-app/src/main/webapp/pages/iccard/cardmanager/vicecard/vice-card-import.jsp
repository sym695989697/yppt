...
<script src="vice-card-import.js" type="text/javascript" charset="utf-8"></script>
...
<body style="padding: 10px;">
	<form action="" name="f_form" id="f_form" enctype="multipart/form-data"
		...
		<div id="editForm1" align="center" style="margin-top: 20px">
				<table border="0">
					<tr class='hideTr'>
						<td align="right" height="50" valign="top">卡类型：</td>
					...
					<tr class='hideTr'>
						<td align="right" height="50" valign="top">所属主卡：</td>
						<td align="left"  height="50" valign="top">
							<input type="text" id="mainCard" name="mainCard"/>
						</td>
					</tr>
					<tr>
