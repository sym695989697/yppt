...
<script src="vice-card-list.js?v=g_version" type="text/javascript" charset="utf-8"></script>
</head>
						...
						<div id="queryCurrencyDiv" style="top: 10px; border-top: 20px;">
							<table style="top: 10px;">
								<tr>
									...
									<td width="100" align="right">卡类型：&nbsp;</td>
									<td width="100" align="left">
									...
									<td width="100" align="right">所属主卡：</td>
									<td width="100" align="left">
										<input name="mainCard" type="text" id="mainCard" />
									</td>
									<td width="100" align="right">是否绑定：</td>
									<td width="100" align="left">
										<input name="isBanding" type="text" id="isBanding" />
									</td>
								...
								<tr>
									...
									<td width="100" align="right">数据来源：</td>
									<td width="100" align="left"> 
