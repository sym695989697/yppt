...
(function ($)
{
    ...
    $.ligerui.controls.ToolBar.ligerExtend($.ligerui.core.UIComponent, {
        ...
        addItem: function (item)
        {
            ...
            if(item.select)
            {
            	var s = '<div class="l-toolbar-item l-panel-btn"><select style=width:' + item.elementWidth + ' id=' + item.elementID + '>' + item.elementOption + '</select><div class="l-panel-btn-l"></div><div class="l-panel-btn-r"></div></div>';
            	var ditem = $(s);
