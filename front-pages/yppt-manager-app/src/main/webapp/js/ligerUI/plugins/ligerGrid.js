...
(function ($)
{
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            gridhtmlarr.push("                      <div id='more_header' class='l-grid-header l-grid-header2'>");
            gridhtmlarr.push("                          <div class='l-grid-header-inner'><table class='l-grid-header-table' cellpadding='0' cellspacing='0'><tbody></tbody></table></div>");
            gridhtmlarr.push("                      </div>");
        ...
        */
        ...
        _fillGridBody: function (data, frozen)
        {
            ...
            {
            	 //没有数据时提示无数据图片或文字 by malq 2012-07-03
                if(data.length<1)
                	gridhtmlarr.push('<div id="noData" style="padding-top:5px; fontfont-size: 12px;">没有符合条件的数据信息</div>');
                else
        ...
        {      	
            ...
            //没有数据时提示无数据图片或文字 by malq 2012-07-03
            //if(data.length<1)
           // 	return '<div id="noData" style="padding-top:5px; fontfont-size: 12px;">没有符合条件的数据信息</div>';
