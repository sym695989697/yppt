package com.ctfo.chpt.bean.iccard.rebate.vo;
...
@Entity(value="TB_REBATE_HISTORY_INFO", noClassnameStored=true)
public class RebateImportInfoVo {
	private static final long serialVersionUID = 1L;
	@Id
	private String id;
	@XmlElement(name = "(注册手机号;NOMAL_ENUM)imp", required = false)
	...
	@XmlElement(name = "(消费金额（元）;NOMAL_ENUM)imp", required = false)
	private String consumeMoney;//消费金额
	private String currencyCount;//返利旺金币数量
	@XmlElement(name = "(返利金额（元）;NOMAL_ENUM)imp", required = false)
