...
<!--top-->
	...
	<div id="main_content" class="main w960 mauto cf help_pages_main">
		...
		<div class="rightsideBar w800 fr menu">
			...
			<div class="pt20">
				<div class="rightsideBar_title">
					<h3 class="fb f14 inline fl">开票详情</h3>
				</div>
				<div class="border_rightBar pb30 pt30">
				    <div class="lists-form">
						<table>
							<tr>
								<td class="lab"><span class="required"></span>提交时间：</td>
								<td class="fld" id="createTime_detail"></td>
								<td class="mark"></td>
							</tr>
							<tr>
								<td class="lab"><span class="required"></span>发票抬头：</td>
								<td class="fld" id="invoiceName"></td>
								<td class="mark"></td>
							</tr>
							<tr>
								<td class="lab"><span class="required"></span>开票金额：</td>
								<td class="fld" id="invoiceMoney"></td>
								<td class="mark"></td>
							</tr>
							<tr>
								<td class="lab"><span class="required"></span><span class="form_fld">收件人信息：</span></td>
								<td class="fld"><span class="block" id="receiverName">张倩   15001063259</span>
                                    <span class="block" id="receiverArea">北京市 大兴区 亦庄 经济技术开发区景园北街2号BDA国际企业大道园区56幢六层<span class="pl10">100191</span></span>
								</td>
								<td class="mark"></td>
							</tr>
						</table>
...
<script type="text/javascript" src="billing_detail.js"></script>
<!-- 页脚 -->
