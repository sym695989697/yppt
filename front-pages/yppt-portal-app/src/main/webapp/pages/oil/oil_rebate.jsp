...
<div class="main">
    <!-- 导航菜单 -->
		<div class="authen_con_chip">
			...
			<li class="fl pl2 pr2 color_chip">&gt;</li>
			<li class="fl pl2 pr2"><a href="<%=basePath%>pages/oil/oil_rebate.jsp">油卡返利</a></li>
			</ul>
		</div>
	<!-- 导航菜单结束-->
	<!--content-->
	<div id="main_content" class="main w960 mauto cf help_pages_main">
		...
		<div class="rightsideBar w800 fr">
			...
			<div class="sideBar_bg border_rightBar p20 h30">
				<ul>
					<li class="f18 fl mr45 color_sizeA">可用旺金币：<span class="posi color_ff fb f24" id="wangGold">0</span>
