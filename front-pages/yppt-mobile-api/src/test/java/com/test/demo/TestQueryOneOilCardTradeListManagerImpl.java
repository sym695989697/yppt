 ...
 * 
 */
public class TestQueryOneOilCardTradeListManagerImpl extends TestCase{

	@Test
	public void testExecute(){
		QueryOneOilCardTradeReq req = new QueryOneOilCardTradeReq();
		req.setCardId("9130290000412004");
		req.setUserId("03f7ba41-9294-4b1d-862c-345b3b59d6cd");
		req.setPage(1);
		req.setPageSize(10);
		
		String url = TestConfig.url + BaseTestUnti.getParam("Y300005", req);
		String result;
		try {
