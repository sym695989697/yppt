 ...
 * 
 */
public class TestMainDataManagerImpl extends TestCase {
	
	@Test
	public void testEecute(){
		MainDataReq req = new MainDataReq();
		req.setUserId("69e9dece-ddef-4aed-9481-d03df0dd07c3");
		
		String url = TestConfig.url + BaseTestUnti.getParam("Y300001", req);
		String result;
		try {
