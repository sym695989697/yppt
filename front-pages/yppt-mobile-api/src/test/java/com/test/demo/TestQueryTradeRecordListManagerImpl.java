 ...
 * 
 */
public class TestQueryTradeRecordListManagerImpl extends TestCase {

	@Test
	public void testExecute(){
		QueryTradeRecordListReq  req = new QueryTradeRecordListReq();
		...
		String url = TestConfig.url + BaseTestUnti.getParam("Y300014", req);
		String result;
		try {
