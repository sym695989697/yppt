 ...
 * @author sunchuanfu
 */
public class GetCashierDeductUrlParams implements Serializable {
	private static final long serialVersionUID = -989939087156786616L;
	...
	private String productCatalog;// 商品类型(例如"1"，对应数据1对应易宝的商品类型"虚拟商品")
